<template>
  <div>    
    <b-navbar v-if="$store.state.dark" class="nav-filter-mobile-light">
    ...
    <b-navbar v-if="!$store.state.dark" class="nav-filter-mobile-dark">
      <b-navbar-nav class="ml-auto">
        <b-nav-item class="d-flex align-items-center pb-1" style="color: #ffffff">
          <nuxt-link class="px-0" to="/about">ABOUT</nuxt-link>
        </b-nav-item>
        <b-nav-item class="d-flex align-items-center pb-1" style="color: #ffffff">
          <nuxt-link class="px-0" to="/tos">TOS</nuxt-link>
        </b-nav-item>
        <b-nav-item v-b-toggle.collapse-1 style="color: #ffffff">
          FILTER
          <img
            class="mb-1"
            src="/images/social/icons8-sort-down-24.png"
